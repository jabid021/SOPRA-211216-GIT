		...
		<form action="" method="post">
			...
			<div class="form-group">
				<label>numero:</label> <input type="number" class="form-control"
					name="numero" value="${employe.adresse.numero}">
			</div>
			<div class="form-group">
				<label>rue:</label> <input class="form-control" name="rue"
					value="${employe.adresse.rue}">
			</div>
			<div class="form-group">
				<label>code postal:</label> <input class="form-control"
					name="codePostal" value="${employe.adresse.codePostal}">
			</div>
			<div class="form-group">
				<label>ville:</label> <input class="form-control" name="ville"
